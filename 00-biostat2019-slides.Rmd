...
- Insertar gráfico explicativo de diferencias
- mostrar gráfico y tablas de variables numéricas
- mostrar cómo hacer una tabla de variables categóricas
- mostrar cómo hacer una tabla 1 descriptiva lista para publicación
- ejercicio: identificar y graficar/tabular
...
- mostrar mapa mental del contenido
- repetir nuevamente el contenido pero enfatiza las preguntas y problemas asociados a su resolución
...
- Dos poblaciones
- crítica: NHST dicotomiza nuestro panorama!
